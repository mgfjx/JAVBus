...
//    lineView.indicatorLineWidth = MainWidth/titles.count;
    ...
    //子控制器
    NSArray *controllers = @[@"MovieMainController", @"MovieMainController", @"MovieMainController", @"MovieMainController", @"ActressCodeController", @"ActressCodeController", @"ActressCodeController"];
